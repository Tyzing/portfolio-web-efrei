...
function ItemProject({ titleProject, descriptionProject, linkProject, imageRight, imageSrc }) {
  const textContent = (
  ...
  return (
    <div className="flex flex-row rounded-[24px] bg-white overflow-hidden shadow-sm w-full min-h-[400px]">
      {imageRight ? (
        <>
          {textContent}
          {imageContent}
